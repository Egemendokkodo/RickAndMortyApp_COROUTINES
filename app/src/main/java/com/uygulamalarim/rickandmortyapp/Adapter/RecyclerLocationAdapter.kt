...
class RecyclerLocationAdapter(private val list: ArrayList<LocationModelMain>) : RecyclerView.Adapter<RecyclerLocationAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        if (selectedPosition == position) {
            changeBackgroundColor(holder.itemView, R.drawable.locationbg)
        } else {
            changeBackgroundColor(holder.itemView, R.drawable.locationbg_unpicked)
        }
    }
